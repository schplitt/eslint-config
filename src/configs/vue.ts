...
export async function vuePreset(options: VueOptions = {}): Promise<Config[]> {
  const {
  ...
  return [
    ...
    },
    {
      ...
      rules: {
        ...
        // TODO: Add Vue accessibility support
        // 'vue-a11y/*': ...
      },
    },
  ]
